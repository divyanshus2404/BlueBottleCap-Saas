    ...
    >
      ...
      >
        ...
        <MarqueeLayer 
          ...
          direction={-1} 
          duration={80} 
          className="text-[8rem] md:text-[12rem] lg:text-[16rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-slate-900/5 to-slate-800/5 " 
        />
        ...
        <MarqueeLayer 
          ...
          direction={1} 
          duration={45} 
          className="text-[5rem] md:text-[8rem] lg:text-[11rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-slate-900/10 to-slate-800/5 ml-12" 
        />
        ...
        <MarqueeLayer 
          ...
          direction={-1} 
          duration={25} 
          className="text-[4rem] md:text-[6rem] lg:text-[8rem] font-black text-transparent bg-clip-text bg-gradient-to-tr from-slate-900/15 to-slate-800/10 " 
        />
      </div>
    </div>
  );
