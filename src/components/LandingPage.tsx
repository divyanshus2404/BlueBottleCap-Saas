    ...
    <div className="fade-in dark:bg-slate-950 min-h-screen transition-colors duration-300">
      ...
      <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="mt-6 font-display text-4.5xl font-black tracking-tight text-brand-navy dark:text-white sm:text-6xl md:text-7xl leading-tight max-w-4xl mx-auto">
            The ultimate arsenal for{" "}
            <span className="bg-linear-to-r from-brand-cobalt to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">
              JEE Mains & Advanced.
            </span>
          </h1>
          
          <p className="mt-6 mx-auto max-w-2xl text-base text-gray-500 dark:text-slate-400 md:text-lg leading-relaxed">
          ...
          <div className="mt-14 max-w-5xl mx-auto relative group perspective-1000">
            ...
            <div className="relative rounded-2xl md:rounded-[2rem] border border-slate-200 dark:border-slate-800/60 dark:border-slate-800 bg-white dark:bg-slate-900/50 backdrop-blur-sm p-2 md:p-3 shadow-2xl transition duration-500 hover:shadow-brand-cobalt/10">
              ...
              <div className="rounded-xl md:rounded-3xl overflow-hidden bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-800 shadow-sm relative z-10">
                ...
                <div className="p-8 pb-16 bg-slate-50 dark:bg-slate-950 flex justify-center">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-brand-cobalt/10 dark:bg-brand-cobalt/20 text-brand-cobalt dark:text-blue-400 flex items-center justify-center text-2xl font-bold mb-6">📚</div>
              <h3 className="text-xl font-bold text-brand-navy dark:text-white mb-3">Premium Notes</h3>
              <p className="text-gray-500 dark:text-slate-400">Access exhaustive, topper-grade notes for Physics, Chemistry, and Math.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-brand-cobalt/10 dark:bg-brand-cobalt/20 text-brand-cobalt dark:text-blue-400 flex items-center justify-center text-2xl font-bold mb-6">⏱️</div>
              <h3 className="text-xl font-bold text-brand-navy dark:text-white mb-3">Virtual Test Mode</h3>
              <p className="text-gray-500 dark:text-slate-400">Practice past papers in an exam-like environment with an active timer.</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 rounded-2xl bg-brand-cobalt/10 dark:bg-brand-cobalt/20 text-brand-cobalt dark:text-blue-400 flex items-center justify-center text-2xl font-bold mb-6">🗣️</div>
              <h3 className="text-xl font-bold text-brand-navy dark:text-white mb-3">Seniors Opinion</h3>
              <p className="text-gray-500 dark:text-slate-400">Read advice, strategies, and download handwritten notes directly from IITians.</p>
            </div>
          </div>
          ...
          <div className="mt-14">
            <button
              ...
              className="inline-flex items-center gap-2.5 bg-brand-navy dark:bg-brand-cobalt hover:bg-brand-cobalt dark:hover:bg-indigo-500 text-white font-bold text-base px-8 py-4 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 cursor-pointer"
            >
      ...
      <section className="py-24 bg-white dark:bg-slate-950 border-b border-gray-100 dark:border-slate-800">
        <div className="mx-auto max-w-5xl px-4 text-center">
          ...
          <div className="overflow-hidden border border-gray-200 dark:border-slate-800 rounded-3xl shadow-sm text-left text-sm md:text-base">
            <div className="grid grid-cols-3 bg-slate-50 dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 font-bold text-brand-navy dark:text-white p-6">
              <div className="col-span-1">Feature</div>
              <div className="col-span-1 text-gray-500 dark:text-slate-400">Traditional Coaching</div>
              <div className="col-span-1 text-brand-cobalt dark:text-blue-400">BlueBottleCap</div>
            </div>
            
            <div className="grid grid-cols-3 border-b border-gray-100 dark:border-slate-800 p-6">
              ...
              <div className="col-span-1 font-medium text-brand-navy dark:text-white">₹281 for full lifetime access.</div>
            </div>
            
            <div className="grid grid-cols-3 border-b border-gray-100 dark:border-slate-800 p-6">
              <div className="col-span-1 font-bold text-gray-700 dark:text-slate-300">Study Material</div>
              <div className="col-span-1 text-gray-500 dark:text-slate-400 pr-4">Heavy, outdated physical books.</div>
              <div className="col-span-1 font-medium text-brand-navy dark:text-white">Digital, updated, and concise chapter-wise notes.</div>
            </div>

            <div className="grid grid-cols-3 border-b border-gray-100 dark:border-slate-800 p-6">
              <div className="col-span-1 font-bold text-gray-700 dark:text-slate-300">Mock Tests</div>
              <div className="col-span-1 text-gray-500 dark:text-slate-400 pr-4">Rigid schedule, fixed timings.</div>
              <div className="col-span-1 font-medium text-brand-navy dark:text-white">Take full syllabus mock tests whenever you want.</div>
            </div>

            <div className="grid grid-cols-3 p-6">
              <div className="col-span-1 font-bold text-gray-700 dark:text-slate-300">Guidance</div>
              <div className="col-span-1 text-gray-500 dark:text-slate-400 pr-4">Hard to reach teachers.</div>
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-900/50 border-b border-gray-100 dark:border-slate-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto text-left">
            <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm relative">
              <div className="text-brand-cobalt dark:text-blue-500 text-4xl mb-4 font-serif">"</div>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed font-medium mb-6">I was struggling with Physics until I found the notes here. The derivation breakdowns and common mistakes sections literally saved me. Also the mock test UI feels exactly like the real JEE exam.</p>
              <div className="font-bold text-brand-navy dark:text-white">Rahul S.</div>
              <div className="text-sm text-gray-500 dark:text-slate-500">JEE Mains 99.2 %ile</div>
            </div>

            <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm relative">
              <div className="text-brand-cobalt dark:text-blue-500 text-4xl mb-4 font-serif">"</div>
              <p className="text-gray-700 dark:text-slate-300 leading-relaxed font-medium mb-6">The Seniors Opinion forum is gold. I downloaded a handwritten organic chemistry short notes PDF from an IIT Delhi senior and it cleared all my doubts in 2 hours.</p>
              <div className="font-bold text-brand-navy dark:text-white">Ananya M.</div>
      ...
      <section className="py-24 text-center relative overflow-hidden bg-brand-navy dark:bg-slate-900 text-white">
        <div className="mx-auto max-w-4xl px-4 relative z-10 space-y-8">
          ...
          <p className="text-lg text-slate-300 dark:text-slate-400 max-w-xl mx-auto">
      ...
      <footer className="border-t border-gray-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/40 dark:bg-slate-950 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-xs text-gray-400 dark:text-slate-600 space-y-4">
          <span className="font-display font-black text-brand-navy dark:text-slate-500">BlueBottleCap</span>
