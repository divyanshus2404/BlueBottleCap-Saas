export interface SeniorPost {
  id: string;
  authorName: string;
  authorCredential: string; // e.g., "IIT Delhi '24" or "AIR 254"
  title: string;
  content: string; // HTML or Markdown format for bolding
  tags: string[];
  upvotes: number;
  datePosted: string;
  attachments?: {
...
export const mockedSeniorPosts: SeniorPost[] = [
  {
    id: "post-1",
...
I've attached my personal short-notes for Rotational Motion below. Notice how I've only written down edge-cases and formulas I used to forget, not everything.`,
    ...
    attachments: [
      {
        name: "Rahul_Rotational_ShortNotes.pdf",
        url: "#"
      }
    ]
  },
