# Institute Leads — Wave 1

Curated Tier-2 / Tier-3 coaching institutes to email first. **Mega-chains
excluded on purpose** — ALLEN, FIITJEE, Aakash, Resonance, PW, Vedantu, Sri
...
## Ready-to-send personalized drafts
...
I saw Mitesh Rathi Classes on MP Nagar — you're one of the few
owner-run JEE brands in Bhopal that hasn't sold out to a chain.
Respect.
...
institute's branding in about 40 seconds per test. Full weak-topic
maps for every student, PDFs with your logo, per-seat pricing
(₹49–99/seat/month, no setup fee).
...
the AI generating a Physics mock live — no slides, no pitch.
...
**Status:** Not sent
**Reply:** —
**Follow-up date:** [set for +4 days after send]
...
I saw the Takshila Institute site — "run by academicians, not
businessmen" caught my eye. That's exactly the mindset I built
BlueBottleCap for.

The AI I built generates chapter-wise JEE mocks in about 40 seconds
per test, with your institute's branding. It doesn't replace
teachers — it removes the *test-generation grind* so your faculty
can focus on the parts of teaching AI can't do (mentoring, doubt-
sessions, motivating a student who bombed a mock).

Per-seat pricing ₹49–99/seat/month. No setup fee. Cancel with
30-day notice.

I'd love to show it live over WhatsApp video for 15 minutes this
week — happy to skip any pitch and just demo the AI generating a
mock in real-time on a chapter you pick.
...
## Where to find the owner's email (5-min per institute)

1. **Their website's Contact page** — look for `founder@`, `director@`, or `admin@[domain]`. Sometimes just `info@`.
2. **LinkedIn** — search `"[institute name] founder"` or `"[institute name] director"`. Free tier lets you send ~20 connect requests/week. Send a connect request first, message when accepted.
3. **Google Maps listing** — the phone number is almost always the owner's WhatsApp for smaller institutes.
4. **Justdial listing** — owner phone + email visible for most Tier-2/3 institutes.
5. **Their Facebook page** — the person who runs the FB page is usually the owner or their kid. Message from there.
...
```
Institute | City | Owner Name | Email/Phone | Sent Date | Reply? | Demo booked? | Outcome | Notes
```

Aim for 20 sends → 5 replies → 2 demos → 1 pilot. That's your one paying customer at ₹5K–20K/month depending on seats.
...
**Tell me:**
- Which 3 you sent
- Whether you got the owner's real email or had to use `info@`
- Any that immediately bounced (bad email = try phone)

I'll help you tune the message based on what actually gets replies.

---

*Written 2026-07-01. Refresh this list monthly — targets change, new ones open.*
